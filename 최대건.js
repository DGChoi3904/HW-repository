...
//만일 하나로 통합하여 관리한다면, 아래와 같이 클래스를 만들면 된다.
...
const fourAO = new FAO();
console.log(fourAO.add(a,b));
console.log(fourAO.minus(a,b));
console.log(fourAO.divide(a,b));
console.log(fourAO.multiply(a,b));
...
console.log(fourAO.reminder(a,1) === 0);
// 11.1이라는 소숫점을 가진 수를 1로 나눌경우, 나머지는 0보다 크기에 false가 된다.
console.log(fourAO.reminder(11.1,1) == 0);
