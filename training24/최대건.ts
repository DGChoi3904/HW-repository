 ...
 */
function diffFinder(targetArray: string[], compareArray: string[], originalArray: string[]) : object {
...
const digimon = ["코로몬", "테일몬", "기브몬", "꼬부기"]
const digimonOriginalData = ["코로몬", "테일몬","기브몬", "어니몬"]
